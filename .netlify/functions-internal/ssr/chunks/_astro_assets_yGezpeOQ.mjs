...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      './astro/assets-service_BeV5J_wA.mjs'
    ).then(n => n.s).catch((e) => {
...
}, "/Users/dylanburkey/Documents/dev/Dylanburkey.box/node_modules/astro/components/Image.astro", undefined);
...
}, "/Users/dylanburkey/Documents/dev/Dylanburkey.box/node_modules/astro/components/Picture.astro", undefined);
